...
class Twig_Extension_Core extends Twig_Extension
{
    ...
    public function getFilters()
    {
        $filters = array(
            ...
            // only for string
            new Twig_SimpleFilter('substring', 'twig_slice', array('needs_environment' => true)),
            new Twig_SimpleFilter('truncate', 'twig_truncated', array('needs_environment' => true)),
            new Twig_SimpleFilter('cutUtf8', 'twig_cutUtf8', array('needs_environment' => true)),
    ...
    {
        return array(
            new Twig_SimpleFunction('range', '__range'),
